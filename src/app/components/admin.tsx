    ...
    const fetchData = async () => {
      try {
        const [
          ...
          fetch(
            `/api/leaves/monthly?month=${selectedMonth}&year=${selectedYear}`
          ),
        ]);
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <div className="bg-blue-100 p-6 rounded-lg shadow-md flex flex-col items-center">
              ...
              <div>
                ...
                <p className="text-3xl mt-2 text-blue-900 text-center">
                  {userCount}
                </p>
              </div>
            </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md mb-8">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-lg font-semibold">
                Leaves in {monthNames[selectedMonth - 1]} {selectedYear}
              </h2>
              <div>
                <select
                  value={selectedMonth}
